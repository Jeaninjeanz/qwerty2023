...
#riskData2 <- riskData %>% 
#  mutate(year = year(date)) %>% 
#  select(year, Name, riskClass, riskClasssd) %>% 
...
saveRDS(riskData2,"~/Desktop/qwerty2023/data/cleaned/CompaniesRisk.rds")

```

```{r}
funData <- read_rds("~/Desktop/qwerty2023/data/cleaned/FundamentalDataCleaned.rds")
fData4 <- fData3

fData5 <- inner_join(funData,fData4,date)
```
